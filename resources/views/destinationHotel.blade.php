...
<body class="bg-gray-100">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full">
                    ...
                    <div class="p-4 flex-grow">
                        <div class="flex justify-between items-start">
                            ...
                            <button onclick="openSaveModal('{{ $hotel->hotel_id }}')"
    ...
    <script>
        ...
        function openSaveModal(hotelId) {
        ...
        function saveToPlan(hotelId, listId) {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            document.querySelectorAll('.planning-option').forEach(el => {
                el.addEventListener('click', () => {
                    ...
                    if (selectedHotelId && listId) {
                        saveToPlan(selectedHotelId, listId);
                    }
                });
            });
        });
